// ============================================================
// VIBETUBE - COMPLETE APP LOGIC (No About)
// ============================================================

import { auth, db, uploadMedia, authFunctions, firestore } from "./firebase.js";
...
// ============================================================
// PAGE NAVIGATION (No About)
// ============================================================
window.showPage = function(page) {
    const pages = ['login', 'signup', 'home', 'profile', 'search', 'chat', 'reels', 
                   'create', 'notification', 'settings', 'wallet', 'hidden-chat'];
...
window.viewPost = function(postId) {
    // For now, just show toast - you can implement post detail view
...
console.log('❌ About section removed');
